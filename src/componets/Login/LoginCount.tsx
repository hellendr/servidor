type LoginCountProps ={
    goCreateCount :()=>void
    goPanel: ()=>void
}

const LoginCount = ({goCreateCount,goPanel}:LoginCountProps) => {
    return (
            ...
            <div className="w-full space-y-6 text-gray-600 sm:max-w-md">
                <div className="text-center">
                    ...
                    <div className="mt-5 space-y-2">
                        <h3 className="text-gray-800 text-2xl font-bold sm:text-3xl">Ingresa a tu cuenta</h3>
                        <p className="">No  tienes cuentas? <a onClick={()=>{goCreateCount()}} className="font-medium text-indigo-600 hover:text-indigo-500">Sign up</a></p>
                    </div>
                </div>
                <div className="bg-white shadow p-4 py-6 space-y-8 sm:p-6 sm:rounded-lg">
                    ...
                    >
                        ...
                        <button
                           onClick={()=>{goPanel()}} className="w-full px-4 py-2 text-white font-medium bg-indigo-600 hover:bg-indigo-500 active:bg-indigo-600 rounded-lg duration-150"
                        >
                            Sign in
                        </button>
                    </form>
                ...
                <div className="text-center">
                    <a href="javascript:void(0)" className="hover:text-indigo-600">¿Olvidaste tu contraseña?</a>
                </div>
            </div>
        </main>
    )
