                ...
                <div className="relative z-10 max-w-xl mx-auto sm:text-center">
                    <div className="space-y-3">
                        ...
                        <h3 className="text-3xl text-white font-bold">
                            Sucribete a Nuestro Blog Informativo
                        </h3>
                        <p className="text-blue-100 leading-relaxed">
                           Deja que llegue a tu correo las mejores guias de como deberias cuidar tu cuerpo y en generla tu salud
                        </p>
                    </div>
                    <div className="mt-6">
                        <form
                        ...
                        <p className="mt-3 max-w-lg text-[15px] text-blue-100 sm:mx-auto">
                           Lee nuestras politicas de tratamiento de datos y cancelacion de  subcripciones <a className="underline" href="javascript:void(0)"> Privacy Policy </a>
                        </p>
                    </div>
                </div>
