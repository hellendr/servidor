    ...
    const testimonials = [
        {
            ...
            name: "Martin Escobar",
            title: "Estudiante de ing Software ",
            quote: "Por fin tengo todo mi historial de salud en un solo lugar. MediTrack me avisa justo cuando lo necesito, es como tener un asistente médico personal."
        },
        {
            avatar: "https://randomuser.me/api/portraits/men/46.jpg",
            name: "Pablo Parraga",
            title: "Est. de ing Industrial",
            quote: "Me encanta lo fácil que es de usar. En pocos minutos registro mis síntomas y tengo reportes claros para mi médico."
        },
        {
            avatar: "https://randomuser.me/api/portraits/men/86.jpg",
            name: "Andres Villamil",
            title: "Est. de Ciecnias Deportes",
            quote: "La app se adapta perfecto a mi rutina. Personalicé mis recordatorios y ahora no olvido ninguna cita ni medicación."
        },
    ]
            ...
            <div className="relative z-10 max-w-screen-xl mx-auto px-4 md:px-8">
                <div className="max-w-xl sm:text-center md:mx-auto">
                    ...
                    <p className="mt-3 text-gray-600">
                        Esto dicen nuestros usuarios mas activos
                    </p>
                </div>
                <div className="mt-12">
